      ...
      >
        ...
        <div>
          ...
          <textarea
            ...
            onChange={handleChange}
            required
            className="w-full p-3 border rounded-lg h-32 resize-none bg-white"
          />
        </div>
        <div className="flex flex-col">
          ...
          <input
            ...
            className="block w-full text-gray-700 bg-white border border-gray-300 rounded-lg cursor-pointer 
